...
import py.una.pol.tesis.pdi.HOpencv;
import py.una.pol.tesis.pdi.OpenCVUtil;


public class SEProblemMO extends AbstractBinaryProblem {
...
private double CS;
    ...
    @Override
    public SolucionMO createSolution() {
        SolucionMO s = new SolucionMO(dimC * dimF - 1);
    ...
    public void evaluate(BinarySolution solucion) {
        evaluate((SolucionMO) solucion);
    }


    public void evaluate(SolucionMO solucion) {
